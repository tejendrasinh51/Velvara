  ...
  return (
    ...
    <div className='flex items-center gap-5'>
        ...
        <img src={assets.profile_icon} className='w-5 cursor-pointer' alt="profile" />
            <div className='group-hover:block hidden absolute dropdown-menu top-0 pt-4'>
                <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 shadow-lg rounded text-gray-500'>
